...
class LSEditPaymentMethod extends StatefulWidget {
  ...
  LSEditPaymentMethod({required this.cardID});
          ...
          onTap: () async {
            if (_formKey.currentState!.validate()) {
              ...
              try {
                ...
                print('Credit card $cardID data: $creditcard');

                // Call the API to add the credit card
                await Provider.of<LSCreditCardAPI>(context, listen: false).editCreditCard(creditCard: creditcard, cardID: cardID, clientID: authService.client!.clientID);

                Fluttertoast.showToast(
                  msg: 'Méthode de Paiement Modifiée avec Succès',
                ...
                print('Error editing credit card: $e');
                Fluttertoast.showToast(
