...
class AppThemeData {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(
      ...
      selectionColor: LSColorPrimary.withOpacity(0.3), // Highlight color for selected text
    ),
    colorScheme: ColorScheme.light(primary: LSColorPrimary).copyWith(secondary: LSColorPrimary),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textSelectionTheme: TextSelectionThemeData(
      ...
      selectionColor: Colors.white.withOpacity(0.3), // Highlight color for selected text
    ),
